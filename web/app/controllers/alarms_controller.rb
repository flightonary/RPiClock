class AlarmsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @alarm.save
        format.html { redirect_to :action => "index", notice: 'Alarm was successfully created.' }
  ...
  private
    ...
    def set_default_alarm
      @alarm.title = "title"
      @alarm.time = Time.now.strftime("%H:%M")
      @alarm.mon = true
      @alarm.tue = true
      @alarm.wed = true
      @alarm.thu = true
    ...
    def alarm_params
      params.require(:alarm).permit(:title, :time, :enabled, :mon, :tue, :wed, :thu, :fri, :sat, :sun, :holiday_off, :sound, :snooze)
    end
end
